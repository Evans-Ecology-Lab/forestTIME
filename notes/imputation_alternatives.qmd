...
Below is a basic workflow to get the "expanded" data with missing values for every year including non-survey years as described in more detail in the [`forestTIME.builder` vignette](https://cct-datascience.r-universe.dev/articles/forestTIME.builder/forestTIME-builder.html).

```{r}
#| eval: false

# Install the most recent version of forestTIME.builder from GitHub:
